...
function AddCard({ onCreate, id }) {
    ...
    const classNameIsAddSecondaryInformationBlocInputPicture = picture === '' ?
        'secondary-information-block__input' : 'secondary-information-block__input-validation'

    const classNameIsAddSecondaryInformationBlocTextareaDescription = description === '' ? 'secondary-information-block__texteria' : 'secondary-information-block__texteria-validation'
            ...
            {isAdd ?
                <form onSubmit={submitHandler}>
                    ...
                    <div className={classNameIsAddSecondaryInformationBlockWrapper}><b>Secondary information</b>
                        ...
                        <input
                            className={classNameIsAddSecondaryInformationBlocInputPicture}
                            id='pictureID'
                            value={picture}
                        ...
                        <textarea
                            className={classNameIsAddSecondaryInformationBlocTextareaDescription}
                            id='description'
                            value={description}
