        ...
        <>
            {isAdd ?
                <form onSubmit={submitHandler}>
                    ...
                    <div className={name === '' || name.length < 5 || article === '' || count === '' || price === '' || creationDate === '' ||
                        ...
                        <input
                            className={splitArticleInput[0] > 'Z' || isNaN(splitArticleInput[1]) || isNaN(splitArticleInput[2]) ?
                    ...
                    <div className={priceSegment === 'cheap' || priceSegment === 'optimal' || priceSegment === 'premium' ?
                        'price-segment-block-wrapper-walidation' : 'price-segment-block-wrapper'}><b>Price segment</b>
                        <hr></hr>
                    ...
                    <div className={description !== '' || picture !== '' ?
                        'secondary-information-block-wrapper-validation' : 'secondary-information-block-wrapper'}><b>Secondary information</b>
                        <hr></hr>
                        ...
                        <textarea
                            className={description === '' ? 'secondary-information-block__texteria' : 'secondary-information-block__texteria-validation'}
                            id='description'
                            value={description}
